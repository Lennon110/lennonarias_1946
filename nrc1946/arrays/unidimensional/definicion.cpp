...
main(){
    ...
    double estatura[]={1.25,1.66,1.78,1.70,1.90};//declaracion e inicializaciion de un vector de 5 elementos
    char sexo[5] = {'M', 'F', 'M', 'F', 'M'};//declaracion e inicializaciion de un vector de 5 elementos
    cout<< "El primer elemento del vector edad es: "<<edad[0]<<endl;
    cout << "El ultimo elementos de estatura es: "<<estatura[4]<<endl;
